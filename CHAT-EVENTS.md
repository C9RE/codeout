...
permission gate, the stats bar, and the persistent log, and only ever sees normalized events.
Gemini and Codex slot in here once their CLIs ship a structured, scriptable output format.
