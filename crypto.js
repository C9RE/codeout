...
export function loadIdentity() {
	...
	try {
		...
		writeFileSync(ID_FILE, JSON.stringify({ publicKey: b64(kp.publicKey), privateKey: b64(kp.privateKey) }, null, 2), { mode: 0o600 });
	} catch (e) {
...
function saveDevices(d) {
	...
	try { mkdirSync(CODEOUT_HOME, { recursive: true, mode: 0o700 }); writeFileSync(DEVICES_FILE, JSON.stringify(d, null, 2), { mode: 0o600 }); }
...
function saveTokens(t) {
	...
	try { mkdirSync(CODEOUT_HOME, { recursive: true, mode: 0o700 }); writeFileSync(TOKENS_FILE, JSON.stringify(t, null, 2), { mode: 0o600 }); }
